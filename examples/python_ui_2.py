...
# Form implementation generated from reading ui file 'coder_dojo_2.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_apellido.setText(_translate("Dialog", "aaaaaa"))
        self.nombre_completo.setText(_translate("Dialog", "Resultado"))
        self.label_nombre.setText(_translate("Dialog", "Nombre"))
        self.lineEdit_nombre.setText(_translate("Dialog", "sssssss"))
